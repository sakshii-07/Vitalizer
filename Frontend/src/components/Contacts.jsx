...
export const Contacts = () => {
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-100 dark:bg-gray-900 pt-24 space-y-6">
      
      {/* Contact Us Heading Card */}
      <div className="w-full max-w-md bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-md p-6 text-center">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="w-full max-w-md bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-md p-6 flex items-center space-x-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition"
      >

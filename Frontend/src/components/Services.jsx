...
export const Services = () => {
  return (
    <div
      className="flex flex-col items-center min-h-screen pt-28 pb-12 relative bg-cover bg-center bg-no-repeat"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center w-full">
        ...
        <div className="grid grid-cols-2 gap-6">
          {/* Card 1 */}
          <div className="flex items-center w-[420px] h-[200px] bg-white/60 dark:bg-gray-800/60 border border-gray-200 rounded-lg shadow-md backdrop-blur-md hover:bg-white/70 dark:hover:bg-gray-800/70 overflow-hidden">
